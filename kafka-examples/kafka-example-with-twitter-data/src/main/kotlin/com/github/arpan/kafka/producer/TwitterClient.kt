...
data class TwitterAuth(val consumerKey: String,
                       val consumerSecret: String,
                       val accessToken: String,
                       val accessTokenSecret: String)

class TwitterClient(private val msgQueue: BlockingQueue<String>,
    ...
    private val hosebirdAuth = OAuth1(twitterAuth.consumerKey,
